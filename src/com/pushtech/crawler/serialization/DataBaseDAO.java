...
public class DataBaseDAO extends DAOFactory {
   ...
   private static final String ORACLE_PROPERTIES_PATH = "";// mdr
   ...
   private DAOFactory buildDAOInstance() {
      ...
      try {
         ...
         url = properties.getProperty(URL_PROPERTY_FIELD);
         login = properties.getProperty(LOGIN_PROPERTY_FIELD);
         password = properties.getProperty(PASSWORD_PROPERTY_FIELD);
      } catch (Exception e) {
         e.printStackTrace();
      }
